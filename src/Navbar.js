    ...
    return (
        ...
        <section className="navbar-bg">
            <nav class="navbar navbar-expand-lg navbar-light ">
                <div class="container">
                    <a class="navbar-brand" href="#">ReactPay</a>
                    ...
                    {/* For toggle funcation of the navbar(removed the id of the div) */}
                    <div class={`collapse navbar-collapse ${show ? "show" : ""}`} >
                        ...
                        <form class="d-flex">
                                <button class="btn  btn-style mx-2" type="submit">Sign Up</button>
